...
const DetailCourse = (props) => {
    ...
    useEffect(()=>{
        ...
        axios.post(`//localhost:5000/api/course/finds/begs`,props.course.beginner)
            .then((response) => {
        ...
        axios.post(`//localhost:5000/api/course/finds/meds`,props.course.medium)
            .then((response) => {
        ...
        axios.post(`//localhost:5000/api/course/finds/advs`,props.course.advanced)
            .then((response) => {
