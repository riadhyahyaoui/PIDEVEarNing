  ...
  const handleStepChange = (step) => {
    ...
    return (
        ...
        <div className="gmap_canvas">
                    	<iframe width="600" height="1900" id="gmap_canvas" src={"https://maps.google.com/maps?q="+item.Address+"&t=&z=10&ie=UTF8&iwloc=&output=embed"} frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                    </div>
        </Grid>
      </Box></div>
                </div>
